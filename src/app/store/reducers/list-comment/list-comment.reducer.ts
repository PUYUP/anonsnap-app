...
export const listCommentFeatureKey = 'listComment';
...
export const initialState: ListCommentState = {
  data: null,
  filter: {},
  error: null,
  status: 'init',
...
export function ListCommentReducer(state: ListCommentState, action: Action) {
